...
Studio as a Vite + React + Tailwind prototype, living in the parent folder). All the business
logic, data model, and Firebase backend are unchanged — only the UI layer and a handful of
browser-only APIs were rewritten for React Native.
